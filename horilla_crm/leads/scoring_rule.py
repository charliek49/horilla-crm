...
from horilla_crm.leads.models import ScoringRule,ScoringCondition, ScoringCriterion
...
@method_decorator(htmx_required, name="dispatch")
@method_decorator(permission_required_or_denied("leads.view_scoringrule"), name="dispatch")
...
@method_decorator(htmx_required, name="dispatch")
@method_decorator(permission_required_or_denied("leads.add_scoringrule"), name="dispatch")
...
@method_decorator(htmx_required, name="dispatch")
@method_decorator(permission_required_or_denied("leads.delete_scoringrule",modal=True), name="dispatch")
...
@method_decorator(htmx_required, name="dispatch")
@method_decorator(permission_required_or_denied("leads.add_scoringcriterion"), name="dispatch")
class ScoringCriterionCreateUpdateView(HorillaSingleFormView):
    ...
    def form_url(self):
        ...
        if pk:
            base_url = reverse_lazy("leads:scoring_rule_criteria_edit_form", kwargs={"pk": pk} if pk else None)
        else:
...
@method_decorator(htmx_required, name="dispatch")
@method_decorator(permission_required_or_denied("leads.delete_scoringcriterion",modal=True), name="dispatch")
...
class ScroringActiveToggleView(LoginRequiredMixin,View):
    ...
    def post(self, request, *args , **kwargs):
        try:
            ...
            if (
                user.is_superuser
                or user.has_perm("leads.change_scoringrule")
            ):
